Ext.define('Ext.ux.button.DateRangePicker', {
    ...
    menu: {
        ...
        items: [{
            ...
            items: [{
                ...
                items: [{
                    xtype: 'label',
                    text: Ext.locale.translate('Start date'),
                ...
                items: [{
                    xtype: 'label',
                    text: Ext.locale.translate('End date'),
                    style: 'font-size: 18px;padding: 5px'
                },
                {
                    xtype: 'datepicker',
            ...
            buttons: [{
                ...
                handler: function(btn) {
                    ...
                    var cmp = this.up('daterangepicker');
                    var customEvents = cmp.customEvents || {};
                    this.up('daterangepicker').setRange();
                    if (customEvents.hasOwnProperty("setRange")) {
                        customEvents.setRange(cmp);
                    }
                }
            }]
    ...
    initComponent: function() {
        ...
        var defaults = {
            ...
            mainBtnTextPrefix: Ext.locale.translate('Period').concat(": "),
            mainBtnIconCls: 'drp-icon-calendar',
            mainBtnTextColor: '#000000',
            confirmBtnText: Ext.locale.translate('Set range'),
            confirmBtnIconCls: 'drp-icon-yes',
            presetPeriodsBtnText: Ext.locale.translate('Preset periods'),
            presetPeriodsBtnIconCls: 'drp-icon-calendar',
            presetPeriodsThisWeekText: Ext.locale.translate('This week'),
            presetPeriodsLastWeekText: Ext.locale.translate('Last week'),
            presetPeriodsThisMonthText: Ext.locale.translate('This month'),
            presetPeriodsLastMonthText: Ext.locale.translate('Last month'),
            presetPeriodsThisYearText: Ext.locale.translate('This year'),
            bindDateFields: true,
        ...
        if (
            me.drpDefaults.showTimePickers && (
                Ext.Date.parse(me.drpDefaults.timePickerFromValue, me.drpDefaults.timeFormat) == null || Ext.Date.parse(me.drpDefaults.timePickerToValue, me.drpDefaults.timeFormat) == null)) {
            ...
            'afterrender': function() {
                ...
                if (drpConfig.showTimePickers) {
                    ...
                    fromContainer.add({
                        ...
                        value: Ext.isEmpty(drpConfig.timePickerFromValue) ? yesterday : Ext.Date.parse(drpConfig.timePickerFromValue, drpConfig.timeFormat),
    ...
    setRange: function() {
        ...
        if (drpConfig.showButtonTip) {
            var tTipText = dFrom + (drpConfig.showTimePickers ? ' ' + Ext.Date.format(me.down('timefield[drpItemRole=timePickerFrom]').getValue(), drpConfig.timeFormat) : '') + ' - ' + dTo + (drpConfig.showTimePickers ? ' ' + Ext.Date.format(me.down('timefield[drpItemRole=timePickerTo]').getValue(), drpConfig.timeFormat) : '');
        ...
        if (
            drpConfig.bindDateFields && drpConfig.boundStartField && drpConfig.boundEndField && drpConfig.boundStartField.isComponent && drpConfig.boundStartField.isXType('datefield') && drpConfig.boundEndField.isComponent && drpConfig.boundEndField.isXType('datefield')) {
    ...
    getPickerValue: function() {
        ...
        var periodInfo = {
            ...
            periodFmt: Ext.Date.format(retObj.startDateObj, drpConfig.dateFormat + ' ' + drpConfig.timeFormat) + ' - ' + Ext.Date.format(retObj.endDateObj, drpConfig.dateFormat + ' ' + drpConfig.timeFormat),
    ...
    setValues: function(vals) {
        this.down('datepicker[drpItemRole=pickFrom]').setValue(new Date(vals.start_time * 1000));
        this.down('datepicker[drpItemRole=pickTo]').setValue(new Date(vals.end_time * 1000));
        this.setRange();
        return this;
    },
    ...
    getValues: function() {
        var me = this;
        return {
            start: me.down('datepicker[drpItemRole=pickFrom]').gettValue(),
            end: me.down('datepicker[drpItemRole=pickTo]').getValue()
        };
    }
});
